        ...
        <div className="flex h-screen w-screen overflow-hidden no-scrollbar">
            ...
            <div className="flex flex-col flex-1 overflow-hidden no-scrollbar">
                ...
                <main className={`flex flex-row flex-grow overflow-x-hidden overflow-y-auto bg-gradient-to-b from-blue-200  transition-all duration-300 `}>
                    <div className={`flex rounded-r-3xl border border-r-gray-400 mobile:max-laptop:absolute   z-20  overflow-auto  flex-shrink-0 transition-all duration-300 mobile:max-tablet:mt-2 ${isDrawerOpen ? 'w-64 ' : 'w-0'} overflow-y-auto no-scrollbar`}>
